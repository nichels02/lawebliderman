        ...
        <>
            ...
            <GridGenerico
                ...
                items={[
                    ...
                    { image: "src/assets/Tiktok.svg", title: "Título 2", text: "Este es un párrafo de ejemplo que acompaña al título. Este es un párrafo de ejemplo que acompaña al título." },
                    { image: "src/assets/Tiktok.svg", title: "Título 3", text: "Texto descriptivo." },
                    { image: "src/assets/Tiktok.svg", title: "Título 4", text: "Este es un párrafo de ejemplo que acompaña al título." },
                ]}
            />
            <FlechaGiro />
            <EspacioVacio />
